...
class Tenant(Base):
    ...
    id = Column(Integer, primary_key=True, index=True, comment="公司ID")
    name = Column(String(255), comment="公司名称")
    code = Column(String(100), unique=True, index=True, comment="公司编号")
    binding_code = Column(String(10), nullable=True, comment="绑定码")
    status = Column(String(20), default="active", comment="状态")
    is_personal = Column(Integer, default=0, comment="是否个人自动创建")
    ...
    product_selections = relationship("ProductSelection", back_populates="tenant", cascade="all, delete-orphan")
